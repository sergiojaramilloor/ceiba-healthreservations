    ...
    stage('Static Code Analysis') {
          steps{
            ...
            withSonarQubeEnv('Sonar') {
                sh "${tool name: 'SonarScanner', type:'hudson.plugins.sonar.SonarRunnerInstallation'}/bin/sonar-scanner -Dsonar.projectKey=sergio.jaramillo_healthCareBackend -Dsonar.projectName=CeibaADN-healthCareBackend -Dproject.settings=./sonar-project.properties"
            }
          }
        }
